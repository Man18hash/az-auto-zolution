...
@php
    ...
    $items       = $invoice->items->filter(function($i){ return $i->line_total > 0; });
    $jobs        = $invoice->jobs->filter(function($j){ return $j->total > 0;   });
  ...
  <div id="invoice-print" class="invoice-main">
    ...
    <div class="details-section">
      ...
      <table class="right-details-table">
        ...
        <tr><td>Address</td><td style="white-space:pre-line">{{ $invoice->address ?? $invoice->client->address ?? '' }}
        </td>
      </tr>
        <tr>
        <td>Contact No.</td>
