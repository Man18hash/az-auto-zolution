...
<div class="container">
  ...
  <div class="card mb-4">
    <div class="card-header d-flex justify-content-between align-items-center">
      ...
      <input id="clientSearch" type="text" class="form-control form-control-sm" placeholder="Search client..." style="width: 200px;">
    </div>
  ...
  <div class="card mb-4">
    <div class="card-header d-flex justify-content-between align-items-center">
      ...
      <input id="vehicleSearch" type="text" class="form-control form-control-sm" placeholder="Search vehicle..." style="width: 200px;">
    </div>
    <div class="card-body p-0">
      <table id="vehiclesTable" class="table mb-0 table-hover">
        <thead>
          <tr>
            <th>Client</th><th>Plate #</th><th>Model</th><th>VIN/Chasis</th>
            <th>Manufacturer</th><th>Year</th><th>Color</th><th>Odometer</th>
          </tr>
        </thead>
        <tbody>
