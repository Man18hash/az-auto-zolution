...
<div class="container mt-4">
  ...
  <form action="{{ isset($invoice) ? route('cashier.appointment.update', $invoice->id) : route('cashier.appointment.store') }}"
...
<div class="col-md-4">
  ...
  {{-- ---------- Recent Appointments (Last 48 Hours) ---------- --}}
  ...
  @if($filtered->isEmpty())
    <p>No Appointment or cancelled in the past 48 hours.</p>
  @else
        ...
        @foreach($filtered as $h)
          <tr>
            ...
            <td class="d-flex gap-1">
              ...
              <form action="{{ route('cashier.appointment.update', $h->id) }}" method="POST" style="display:inline-flex;align-items:center;">
                @csrf @method('PUT')
